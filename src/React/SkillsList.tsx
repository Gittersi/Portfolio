...
const CategoryIcons = {
  ...
  "Agentic AI & RAG": (
    <svg
      ...
      className="w-6 h-6 text-[var(--sec)] opacity-70"
    >
      <path d="M12 2C9.243 2 7 4.243 7 7V8C5.343 8 4 9.343 4 11V19C4 20.657 5.343 22 7 22H17C18.657 22 20 20.657 20 19V11C20 9.343 18.657 8 17 8V7C17 4.243 14.757 2 12 2ZM12 4C13.654 4 15 5.346 15 7V8H9V7C9 5.346 10.346 4 12 4ZM9 13C9.552 13 10 13.448 10 14C10 14.552 9.552 15 9 15C8.448 15 8 14.552 8 14C8 13.448 8.448 13 9 13ZM15 13C15.552 13 16 13.448 16 14C16 14.552 15.552 15 15 15C14.448 15 14 14.552 14 14C14 13.448 14.448 13 15 13ZM12 17C13.105 17 14 17.895 14 19H10C10 17.895 10.895 17 12 17Z"></path>
    </svg>
  ),
